...
document.getElementById("Fragility").addEventListener("click", function(){
		if(document.getElementById("Fragility").value === 'off')
		{
			...
			$(document).ready(function(){
				...
				$('#CountriesText').delay(5000);
				$('#CountriesText').animate({opacity: '0'}, 2000);
				$('#CountriesText').html('<h2>"Fragility"</h2><br>China	98<br>India	338<br>Indonesia	4<br>Pakistan	31886<br>Bangladesh	6270<br>Russia	1567<br>Japan	9561<br>Philippines	41105<br>Thailand	3471<br>Myanmar	1705<br>South Korea	2534<br>Malaysia	20722<br>Nepal	2809<br>North Korea	622<br>Australia	233627<br>Taiwan	5263<br>Sri Lanka	4647<br>Cambodia	1645<br>Papua New Guinea	331<br>Laos	189<br>Singapore	8345<br>New Zealand	141879<br>Fiji	3702<br>Bhutan	687<br>Samoa	503<br>Tonga	113<br>Cook Islands	298<br>Afghanistan	4151<br>Vanuatu	484<br>Solomon Islands	241');
			});
...
document.getElementById("Instability").addEventListener("click", function(){
		if(document.getElementById("Instability").value === 'off')
		{
			...
			$(document).ready(function(){
				...
				$('#CountriesText').delay(5000);
				$('#CountriesText').animate({opacity: '0'}, 2000);
				$('#CountriesText').html('<h2>"Instability"</h2><br>China	138<br>India	1783<br>Indonesia	25<br>Pakistan	31886<br>Bangladesh	6270<br>Russia	1567<br>Japan	9561<br>Philippines	41105<br>Thailand	3471<br>Myanmar	1705<br>South Korea	2534<br>Malaysia	20722<br>Nepal	2809<br>North Korea	622<br>Australia	233627<br>Taiwan	5263<br>Sri Lanka	4647<br>Cambodia	1645<br>Papua New Guinea	331<br>Laos	189<br>Singapore	8345<br>New Zealand	141879<br>Fiji	3702<br>Bhutan	687<br>Samoa	503<br>Tonga	113<br>Cook Islands	298<br>Afghanistan	4151<br>Vanuatu	484<br>Solomon Islands	241');
			});
...
document.getElementById("Risk").addEventListener("click", function(){
		if(document.getElementById("Risk").value === 'off')
		{
			...
			$(document).ready(function(){
				...
				$('#CountriesText').delay(5000);
				$('#CountriesText').animate({opacity: '0'}, 2000);
				$('#CountriesText').html('<h2>"Risk"</h2><br>China	1076<br>India	25168<br>Indonesia	317<br>Pakistan	31886<br>Bangladesh	6270<br>Russia	1567<br>Japan	9561<br>Philippines	41105<br>Thailand	3471<br>Myanmar	1705<br>South Korea	2534<br>Malaysia	20722<br>Nepal	2809<br>North Korea	622<br>Australia	233627<br>Taiwan	5263<br>Sri Lanka	4647<br>Cambodia	1645<br>Papua New Guinea	331<br>Laos	189<br>Singapore	8345<br>New Zealand	141879<br>Fiji	3702<br>Bhutan	687<br>Samoa	503<br>Tonga	113<br>Cook Islands	298<br>Afghanistan	4151<br>Vanuatu	484<br>Solomon Islands	241');
			});
...
document.getElementById("Survival").addEventListener("click", function(){
		if(document.getElementById("Survival").value === 'off')
		{
			...
			$(document).ready(function(){
				...
				$('#CountriesText').delay(5000);
				$('#CountriesText').animate({opacity: '0'}, 2000);
				$('#CountriesText').html('<h2>"Survival"</h2><br>China	167<br>India	4254<br>Indonesia	30<br>Pakistan	31886<br>Bangladesh	6270<br>Russia	1567<br>Japan	9561<br>Philippines	41105<br>Thailand	3471<br>Myanmar	1705<br>South Korea	2534<br>Malaysia	20722<br>Nepal	2809<br>North Korea	622<br>Australia	233627<br>Taiwan	5263<br>Sri Lanka	4647<br>Cambodia	1645<br>Papua New Guinea	331<br>Laos	189<br>Singapore	8345<br>New Zealand	141879<br>Fiji	3702<br>Bhutan	687<br>Samoa	503<br>Tonga	113<br>Cook Islands	298<br>Afghanistan	4151<br>Vanuatu	484<br>Solomon Islands	241');
			});
		}
...
document.getElementById("Vulnerability").addEventListener("click", function(){
		if(document.getElementById("Vulnerability").value === 'off')
		{
			...
			$(document).ready(function(){
				...
				$('#CountriesText').delay(5000);
				$('#CountriesText').animate({opacity: '0'}, 2000);
				$('#CountriesText').html('<h2>"Vulnerability"</h2><br>China	51<br>India	2213<br>Indonesia	21<br>Pakistan	31886<br>Bangladesh	6270<br>Russia	1567<br>Japan	9561<br>Philippines	41105<br>Thailand	3471<br>Myanmar	1705<br>South Korea	2534<br>Malaysia	20722<br>Nepal	2809<br>North Korea	622<br>Australia	233627<br>Taiwan	5263<br>Sri Lanka	4647<br>Cambodia	1645<br>Papua New Guinea	331<br>Laos	189<br>Singapore	8345<br>New Zealand	141879<br>Fiji	3702<br>Bhutan	687<br>Samoa	503<br>Tonga	113<br>Cook Islands	298<br>Afghanistan	4151<br>Vanuatu	484<br>Solomon Islands	241');
			});
