...
//particle creators
	var cChangeSystem = new particleGenerator(849326/10, 7, 'rgb(0, 150, 0)');
	var conflictSystem = new particleGenerator(28394/10, 7, 'rgb(255, 0, 0)');
	var fragilitySystem = new particleGenerator(1008/10, 7, 'rgb(150, 100, 255)');
	var instabilitySystem = new particleGenerator(6271/10, 7, 'rgb(255, 200, 0)');
	var riskSystem = new particleGenerator(98397/10, 7, 'rgb(255, 0, 120)');
	var survivalSystem = new particleGenerator(14575/10, 7, 'rgb(0, 150, 255)');
	var violenceSystem = new particleGenerator(44486/10, 7, 'rgb(255, 100, 0)');
	var vulnerabilitySystem = new particleGenerator(6155/10, 7, 'rgb(255, 100, 100)');
	var warfareSystem = new particleGenerator(3718/10, 7, 'rgb(50, 0, 255)');
