...
document.getElementById("Fragility").addEventListener("click", function(){
		...
		{
			document.getElementById("Fragility").style.cssText = 'color: rgb(100, 100, 255)';
...
document.getElementById("Survival").addEventListener("click", function(){
		...
		{
			document.getElementById("Survival").style.cssText = 'color: rgb(0, 255, 255)';
...
document.getElementById("Vulnerability").addEventListener("click", function(){
		...
		{
			document.getElementById("Vulnerability").style.cssText = 'color: rgb(255, 0, 100)';
...
//particle creators
	...
	var fragilitySystem = new particleGenerator(1008/10, 5, 'rgb(100, 100, 255)');
